# CALENDÁRIO LEONÍSTICO — atividades de julho/2026 a junho/2027
#
# Organize as atividades embaixo do mês certo (## Mês Ano).
# Cada atividade é um BLOCO de linhas "campo: valor", separado do próximo
# por UMA LINHA EM BRANCO. Copie um bloco inteiro para criar outro.
#
# Campos:
#   tipo        -> campanha | evento | reuniao | comemorativa   (define ícone e cor)
#   data        -> DD/MM/AAAA
#   hora        -> opcional (ex.: 20h, 19h30). Deixe em branco se não tiver.
#   titulo      -> nome da atividade
#   local       -> nome do local físico e/ou endereço. Se a atividade for
#                  on-line, coloque o link (começando com https://) que ele
#                  vira um botão "On-line" clicável.
#   responsavel -> quem coordena (opcional)
#   detalhes    -> texto que aparece no popup "ver detalhes" (UMA linha só)
#   link        -> opcional (inscrição, álbum de fotos, etc.)
#
# Mês sem nenhum bloco aparece como "sem atividades" (e continua navegável).
...
local: https://meet.google.com/bkv-vtzj-ght
responsavel: Presidente
...
local: Sede do clube e comércios parceiros
responsavel: Carlos M.
detalhes: Pontos de coleta na sede e em comércios parceiros.
link:
